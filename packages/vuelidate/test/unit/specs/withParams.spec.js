import withParams from 'packages/vuelidate/src/withParams'
import { target, _setTarget } from 'packages/vuelidate/src/params'
...
describe('withParams validator modifier', () => {
  ...
  it('should throw on string params in closure', () => {
    ...
    expect(v).toThrowError('params must be an object')
  })
  ...
  it('should return a function', () => {
    expect(typeof withParams({}, func)).toBe('function')
  })

  it("should not alter function's output", () => {
    expect(withParams({}, () => 'hello')()).toBe('hello')
  })

  it("should not alter function's input", () => {
    expect(withParams({}, (x) => x)('world')).toBe('world')
  })
  ...
  it('should add params after function evaluation', () => {
    ...
    expect(target.$sub[0]).toEqual($params)
  })
  ...
  it('should stack combining params to $sub key', () => {
    ...
    expect(target.$sub[0]).toEqual({ a: 1, b: 2, $sub: [{ a: 0, c: 3 }] })
  })
